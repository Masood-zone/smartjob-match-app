      ...
      <DialogContent className="max-w-3xl p-0">
        <div className="relative overflow-hidden bg-surface p-6 sm:p-8">
          ...
          <DialogHeader className="text-left">
            ...
            <DialogDescription className="mt-2 max-w-2xl text-sm leading-6 text-on-surface-variant">
              Your employer profile has been saved and sent for review. We will
              keep the record available in your dashboard so you can return to
              it at any time.
            </DialogDescription>
          </DialogHeader>

          <div className="mt-6 grid gap-4 md:grid-cols-[minmax(0,1.18fr)_minmax(280px,0.82fr)]">
